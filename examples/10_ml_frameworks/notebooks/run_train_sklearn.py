...
# MAGIC %md
# MAGIC # 10 · scikit-learn — a gradient-boosted tree
# MAGIC
...
if not task_dir:
    ...
    task_dir = str(example_root / "pipelines" / "fare_bench" / "ml" / "train_sklearn")
...
latest = metrics.filter("framework = 'scikit-learn'")
