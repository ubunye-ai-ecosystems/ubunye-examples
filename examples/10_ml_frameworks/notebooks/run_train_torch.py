...
# MAGIC %md
# MAGIC # 10 · PyTorch — a neural network on CPU
# MAGIC
...
# MAGIC %pip install "ubunye-engine[spark,ml]==0.3.0" torch
...
if not task_dir:
    ...
    task_dir = str(example_root / "pipelines" / "fare_bench" / "ml" / "train_torch")
...
latest = metrics.filter("framework = 'pytorch'")
